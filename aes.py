...
Original file is located at
    https://colab.research.google.com/drive/1R57XrspytCYaQ0Yu53gmRfKN411NDUej
"""
...
# ------------ Custom key (16 bytes) ------------
key_base=[0x71, 0x61, 0x7a, 0x77, 0x73, 0x78, 0x65, 0x64, 0x63, 0x72, 0x66, 0x76, 0x74, 0x67, 0x62, 0x79]
key = []
...
for i in range(129600):
    ...
    for j in range(16):
        key_byte=key_base[j]
        tmp.append(hex(key_byte)[2:].zfill(2))
#     print(tmp)
    key.append(tmp)
...
plaintext_b, plaintext_g, plaintext_r = image_hex_array("output_resize.png")
