...
from graffiti_v2 import GraffitiDialog
from image_padding import image_resize
...
class MainWindow(QMainWindow, Ui_Dialog):
    ...
    def on_confirm_clicked(self):
        ...
        output_image_path = './img/output_resize.png'

        image_resize(input_image_path, 1920, 1080, output_image_path)
    ...
    def on_pwd_confirm_clicked(self):
        ...
        plaintext_b, plaintext_g, plaintext_r = image_hex_array("./img/output_resize.png")
